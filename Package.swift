...
let package = Package(
    ...
    dependencies: [
//		.package(url: "https://github.com/cotyapps/Kovalee-iOS-SDK", from: Version(1, 6, 0)),
		.package(url: "https://github.com/cotyapps/Kovalee-iOS-SDK", branch: "local-abtest-value"),
